...
class GeneralSettingsBase(BaseModel):
    ...
    dnstt_mtu: int = Field(1232, ge=50, le=1400)
    dnstt_mtu_upload_min: int = Field(472, ge=50, le=1400)
    dnstt_mtu_upload_max: int = Field(1204, ge=50, le=1400)
    dnstt_mtu_download_min: int = Field(472, ge=50, le=1400)
    dnstt_mtu_download_max: int = Field(1204, ge=50, le=1400)
