    ...
    with engine.begin() as connection:
        ...
        if general_settings_table_exists:
            ...
            general_column_migrations = {
                ...
                "dnstt_domain": "ALTER TABLE general_settings ADD COLUMN dnstt_domain VARCHAR(1024)",
                "dnstt_active_domain": "ALTER TABLE general_settings ADD COLUMN dnstt_active_domain VARCHAR(255)",
                "dnstt_dns_resolver": "ALTER TABLE general_settings ADD COLUMN dnstt_dns_resolver VARCHAR(1024) NOT NULL DEFAULT '8.8.8.8'",
                "dnstt_resolver_strategy": "ALTER TABLE general_settings ADD COLUMN dnstt_resolver_strategy VARCHAR(32) NOT NULL DEFAULT 'failover'",
                "dnstt_duplication_mode": "ALTER TABLE general_settings ADD COLUMN dnstt_duplication_mode INTEGER NOT NULL DEFAULT 1",
                "dnstt_mtu_mode": "ALTER TABLE general_settings ADD COLUMN dnstt_mtu_mode VARCHAR(32) NOT NULL DEFAULT 'preset'",
                "dnstt_mtu": "ALTER TABLE general_settings ADD COLUMN dnstt_mtu INTEGER NOT NULL DEFAULT 1232",
                "dnstt_mtu_upload_min": "ALTER TABLE general_settings ADD COLUMN dnstt_mtu_upload_min INTEGER NOT NULL DEFAULT 472",
                "dnstt_mtu_upload_max": "ALTER TABLE general_settings ADD COLUMN dnstt_mtu_upload_max INTEGER NOT NULL DEFAULT 1204",
                "dnstt_mtu_download_min": "ALTER TABLE general_settings ADD COLUMN dnstt_mtu_download_min INTEGER NOT NULL DEFAULT 472",
                "dnstt_mtu_download_max": "ALTER TABLE general_settings ADD COLUMN dnstt_mtu_download_max INTEGER NOT NULL DEFAULT 1204",
                "dnstt_adaptive_per_resolver": "ALTER TABLE general_settings ADD COLUMN dnstt_adaptive_per_resolver BOOLEAN NOT NULL DEFAULT 1",
                "dnstt_transport_probe_workers": "ALTER TABLE general_settings ADD COLUMN dnstt_transport_probe_workers INTEGER NOT NULL DEFAULT 2",
                "dnstt_transport_retry_count": "ALTER TABLE general_settings ADD COLUMN dnstt_transport_retry_count INTEGER NOT NULL DEFAULT 2",
                "dnstt_transport_probe_timeout_ms": "ALTER TABLE general_settings ADD COLUMN dnstt_transport_probe_timeout_ms INTEGER NOT NULL DEFAULT 2000",
                "dnstt_transport_switch_threshold_percent": "ALTER TABLE general_settings ADD COLUMN dnstt_transport_switch_threshold_percent INTEGER NOT NULL DEFAULT 20",
                "dnstt_telemetry": "ALTER TABLE general_settings ADD COLUMN dnstt_telemetry JSON",
                "dnstt_telemetry_history": "ALTER TABLE general_settings ADD COLUMN dnstt_telemetry_history JSON",
                ...
                connection.execute(
                    text(
                        ...
                        INSERT INTO general_settings (
                            ...
                            dnstt_active_domain,
                            dnstt_dns_resolver,
                            dnstt_resolver_strategy,
                            dnstt_duplication_mode,
                            dnstt_mtu_mode,
                            dnstt_mtu,
