...
class GeneralSettings(Base):
    ...
    enable_vless = Column(Boolean, nullable=False, default=True)
    vless_port = Column(Integer, nullable=False, default=443)
    singbox_reality_sni = Column(String(255), nullable=False, default="yahoo.com")
    singbox_reality_public_key = Column(Text, nullable=False, default="")
    singbox_reality_private_key = Column(Text, nullable=False, default="")
    singbox_reality_short_ids = Column(String(255), nullable=False, default="0123456789abcdef")
